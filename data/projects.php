...
return [
  ...
  [
   // group 12
    ...
    'overview' => 'Web Based Final Year Project Supervision Database Management System . UniManage Portal is a database-backed platform for managing final-year project supervision in a university department. It gives each student a single dashboard showing their assigned topic, supervisor, chapter submission status, overall progress percentage, and upcoming supervisor meetings — replacing the usual scatter of email threads, paper logs, and spreadsheet trackers that departments tend to run this process on.',
