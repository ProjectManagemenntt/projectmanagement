...
return [
  ...
  [
   // group 4
    ...
    'title' => 'OAU Research & Innovation Repository',
    'category' => 'Academic Research Infrastructure',
    'duration' => '4 months',
    'sector' => 'Higher Education / Research Administration',
    'summary' => 'A single university-wide repository for publications, researchers, innovations, and patents — searchable, reviewed, and built for real-world partnerships.',
    'overview' => 'The OAU Research & Innovation Repository is Obafemi Awolowo University\'s official platform for preserving and showcasing scholarly output at scale: journal articles, conference papers, theses, and technical reports sit alongside researcher profiles, departments and faculties, and — distinctly — innovations and patents routed through the university\'s IP and Technology Transfer Office (IPTTO). A researcher adds their work once; students, collaborators, funders, policymakers, and industry partners can all find it from the same place.',
    'challenge' => 'University research output is usually scattered across departmental pages, personal sites, and journal paywalls, which makes it hard for anyone — a student, an industry partner, a funder — to answer a simple question: what has this university actually produced, and who made it? The problem compounds for anything with commercial potential: without a defined path from "interesting research finding" to "patent application," promising innovations tend to stay published papers and nothing more.',
    'approach' => 'The repository was structured around two connected tracks. The academic track organizes every publication by researcher, department, faculty, and research area (AI, agriculture, renewable energy, medicine, and more), with each entry reviewed and approved by the university before appearing publicly — so a search returns vetted work, not a self-published claim. The innovation track sits alongside it, explicitly built to carry a finding from publication through to patent and, ultimately, industry partnership, with a direct path for researchers to flag commercial-potential work to IPTTO rather than leaving it to be discovered by chance.',
    'outcome' => 'The result is a single, university-endorsed front door to OAU\'s research output — publications, the people behind them, and a distinct, purpose-built pipeline that turns qualifying research into protected, commercially usable innovation instead of a paper that stops at publication.',
    'tags' => ['Research repository', 'Technology transfer', 'Academic publishing'],
    'live_url' => 'https://oau-research-and-innovation.vercel.app/',
    'accent' => 'research',
  ],
  [
   // group 5
